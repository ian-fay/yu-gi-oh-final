...
function MonsterCard(cardName, cardType, cardArchetype, cardText, cardArt, favorite, cardPrices){
    // this says: Call the GameCard function, using the object from this card as "this" in the function
    GameCard.call(this, cardName, cardType, cardArchetype, cardText, cardArt, favorite, cardPrices);
